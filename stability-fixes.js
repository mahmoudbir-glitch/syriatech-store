/* Syriatech stability fixes — frontend compatibility */
(function(){
  const style=document.createElement("style");
  style.textContent=
    "#overlay{position:fixed;inset:0;background:rgba(7,17,31,.48);z-index:40;opacity:0;visibility:hidden;transition:.2s}#overlay.open{opacity:1;visibility:visible}"+
